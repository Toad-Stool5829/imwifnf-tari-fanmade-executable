	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['Original Mod by'], 15);
					#else
					createCoolText(['Original Mod by']);
					#end
				// credTextShit.visible = true;
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('Glitch Productions', 15);
					#else
					addMoreText('Glitch Productions');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['Psych Version by'], -40);
					#else
					createCoolText(['Psych Version by'], -40);
					#end
				case 7:
					addMoreText('Toad Stool', -40);
					ngSpr.visible = false;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('If Mario Was In');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Friday Night Funkin');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('But Only Tari Showed Up'); // credTextShit.text += '\nFunkin';
